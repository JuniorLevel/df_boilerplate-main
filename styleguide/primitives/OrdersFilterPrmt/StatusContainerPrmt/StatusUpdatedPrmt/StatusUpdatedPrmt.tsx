...
import { useStyles } from './StatusUpdatedPrmt.styles';

interface IStatusUpdatedPrmtProps {
	children: ReactNode;
	counter: number;
}

export const StatusUpdatedPrmt: FC<IStatusUpdatedPrmtProps> = ({ children, counter }) => {
